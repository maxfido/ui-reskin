...
export const SKILLS: Skill[] = [
  ...
  },
  {
    ...
    description: 'Start a new loan application, get matched with lenders, and track your progress from submission to funding.',
    icon: 'Banknote',
    color: '#E85D1A',
    available: true,
  ...
  },
  {
    ...
    name: 'Incorporate',
    tagline: 'Coming soon.',
    description: 'Form your LLC, stay compliant, and handle annual filings all through Fido.',
    icon: 'Building2',
    color: '#888886',
    available: false,
    mockOpener: '',
  },
  {
    ...
    name: 'Win Customers',
    tagline: 'Coming soon.',
    description: 'Find your next customer. Fido builds your presence and helps drive revenue.',
    icon: 'TrendingUp',
    color: '#888886',
    available: false,
    mockOpener: '',
  },
  {
    ...
    tagline: 'Coming soon.',
    description: 'Build a compelling investor pitch deck tailored to your business and funding goal.',
    icon: 'Presentation',
    color: '#888886',
    available: false,
    mockOpener: '',
  },
  {
    ...
    tagline: 'Coming soon.',
    description: 'Launch a professional business website with Fido without needing code.',
    icon: 'Globe',
    color: '#888886',
    available: false,
    mockOpener: '',
